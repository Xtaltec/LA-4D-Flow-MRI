"""
Script to save the Paraview state after correcting the position of the flow rate measuring vessel cross-sections
in each structure after running CreateFRPlanes.py and FRClipUpdate.py.
...
states_path = Path(DATA_PATH, "processed", "ParaviewStates", "flow_rate")
